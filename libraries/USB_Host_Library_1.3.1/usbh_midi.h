 ...
 * using MAX3421E host controller IC
 *
 * Based on 2012-2017 code by Yuuichi Akagawa
 * This version modified to set MIDI_MAX_SYSEX_SIZE 1024
 *
...
// default size limit is 256 bytes
//#define MIDI_MAX_SYSEX_SIZE   256

// experimental 1024 byte size 2025 apr 01
...
{
protected:
        static const uint8_t    epDataInIndex;    // In endpoint index(MIDI)
        static const uint8_t    epDataOutIndex;   // OUT endpoint index(MIDI)
        static const uint8_t    epDataInIndexVSP; // In Vendor Specific Protocl
        static const uint8_t    epDataOutIndexVSP;// OUT Vendor Specific Protocl
